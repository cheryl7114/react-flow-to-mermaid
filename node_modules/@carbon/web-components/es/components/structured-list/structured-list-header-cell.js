...
//#region src/components/structured-list/structured-list-header-cell.ts
/**
...
CDSStructuredListHeaderCell = __decorate([carbonElement(`${prefix}-structured-list-header-cell`)], CDSStructuredListHeaderCell);
var structured_list_header_cell_default = CDSStructuredListHeaderCell;

//#endregion
export { structured_list_header_cell_default as default };
