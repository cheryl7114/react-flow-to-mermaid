...
let CDSRadioButtonGroup = class CDSRadioButtonGroup extends FormMixin(HostListenerMixin(LitElement)) {
	...
	*/
	...
	render() {
		...
		const invalidIcon = iconLoader(WarningFilled16, { class: `${prefix}--radio-button__invalid-icon` });
		const warnIcon = iconLoader(WarningAltFilled16, { class: `${prefix}--radio-button__invalid-icon ${prefix}--radio-button__invalid-icon--warning` });
        ...
        ${legendText ? html` <legend class="${prefix}--label">
              ${legendText}
      ...
      <div class="${prefix}--radio-button__validation-msg">
        ${!readOnly && !disabled && invalid ? html`
              ${invalidIcon}
...
CDSRadioButtonGroup = __decorate([carbonElement(`${prefix}-radio-button-group`)], CDSRadioButtonGroup);
var radio_button_group_default = CDSRadioButtonGroup;

//#endregion
export { RADIO_BUTTON_ORIENTATION, radio_button_group_default as default };
