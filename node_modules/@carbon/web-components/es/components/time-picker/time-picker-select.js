...
CDSTimePickerSelect = __decorate([carbonElement(`${prefix}-time-picker-select`)], CDSTimePickerSelect);
var time_picker_select_default = CDSTimePickerSelect;

//#endregion
export { time_picker_select_default as default };
