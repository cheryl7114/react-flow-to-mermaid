...
CDSTableSkeleton = __decorate([carbonElement(`${prefix}-table-skeleton`)], CDSTableSkeleton);
var table_skeleton_default = CDSTableSkeleton;

//#endregion
export { table_skeleton_default as default };
