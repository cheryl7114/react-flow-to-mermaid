...
CDSTableExpandedRow = __decorate([carbonElement(`${prefix}-table-expanded-row`)], CDSTableExpandedRow);
var table_expanded_row_default = CDSTableExpandedRow;

//#endregion
export { table_expanded_row_default as default };
