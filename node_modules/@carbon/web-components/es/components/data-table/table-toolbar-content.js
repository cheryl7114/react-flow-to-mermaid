...
CDSTableToolbarContent = __decorate([carbonElement(`${prefix}-table-toolbar-content`)], CDSTableToolbarContent);
var table_toolbar_content_default = CDSTableToolbarContent;

//#endregion
export { table_toolbar_content_default as default };
