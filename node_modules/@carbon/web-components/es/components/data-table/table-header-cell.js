...
let CDSTableHeaderCell = class CDSTableHeaderCell extends FocusMixin(LitElement) {
	...
	*/
	_getNextSort() {
		...
		if (index < 0) {
			if (sortDirection === TABLE_SORT_DIRECTION.NONE) return directions[0];
	...
	*/
	...
	updated(changedProperties) {
		if (this.isSortable && !changedProperties.has("sortDirection") && !this.sortDirection) this.sortDirection = TABLE_SORT_DIRECTION.NONE;
	...
	render() {
		...
		if (sortDirection) {
			const sortIcon = sortDirection === TABLE_SORT_DIRECTION.NONE ? iconLoader(ArrowsVertical32, {
				part: "sort-icon",
...
CDSTableHeaderCell = __decorate([carbonElement(`${prefix}-table-header-cell`)], CDSTableHeaderCell);
var table_header_cell_default = CDSTableHeaderCell;

//#endregion
export { TABLE_SORT_CYCLE, TABLE_SORT_CYCLES, TABLE_SORT_DIRECTION, table_header_cell_default as default };
