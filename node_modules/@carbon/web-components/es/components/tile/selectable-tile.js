...
CDSSelectableTile = __decorate([carbonElement(`${prefix}-selectable-tile`)], CDSSelectableTile);
var selectable_tile_default = CDSSelectableTile;

//#endregion
export { selectable_tile_default as default };
