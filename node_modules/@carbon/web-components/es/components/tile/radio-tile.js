...
import selectable_tile_default from "./selectable-tile.js";
...
*/
let CDSRadioTile = class CDSRadioTile extends selectable_tile_default {
	constructor(..._args) {
		super(..._args);
...
CDSRadioTile = __decorate([carbonElement(`${prefix}-radio-tile`)], CDSRadioTile);
var radio_tile_default = CDSRadioTile;

//#endregion
export { radio_tile_default as default };
