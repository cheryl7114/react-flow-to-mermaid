...
*/
let CDSClickableTile = class CDSClickableTile extends link_default {
	constructor(..._args) {
		super(..._args);
	...
	*/
	_renderInner() {
		return html`
      ${super._renderInner()}
      ${this.aiLabel || this.slug ? iconLoader(AILabel24, { class: `${prefix}--tile--ai-label-icon` }) : ""}
...
CDSClickableTile = __decorate([carbonElement(`${prefix}-clickable-tile`)], CDSClickableTile);
var clickable_tile_default = CDSClickableTile;

//#endregion
export { clickable_tile_default as default };
