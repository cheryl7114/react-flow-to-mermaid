...
let CDSTileGroup = class CDSTileGroup extends HostListenerMixin(LitElement) {
	constructor(..._args) {
		...
		this._handleKeydown = (event) => {
			...
			if (target?.matches(`${prefix}-ai-label`)) return;
...
CDSTileGroup = __decorate([carbonElement(`${prefix}-tile-group`)], CDSTileGroup);
var tile_group_default = CDSTileGroup;

//#endregion
export { tile_group_default as default };
