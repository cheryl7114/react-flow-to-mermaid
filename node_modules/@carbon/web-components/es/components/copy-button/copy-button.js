...
import copy_button_default$1 from "./copy-button.scss.js";
import "../copy/copy.js";
...
let CDSCopyButton = class CDSCopyButton extends FocusMixin(LitElement) {
	...
	static {
		this.styles = copy_button_default$1;
	}
};
__decorate([property({
	reflect: true,
...
CDSCopyButton = __decorate([carbonElement(`${prefix}-copy-button`)], CDSCopyButton);
var copy_button_default = CDSCopyButton;
