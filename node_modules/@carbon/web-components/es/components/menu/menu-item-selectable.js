...
let CDSmenuItemSelectable = class CDSmenuItemSelectable extends LitElement {
	...
	*/
	...
	firstUpdated() {
		const menuItemSelectable = this.shadowRoot?.querySelector(`${prefix}-menu-item`);
		if (menuItemSelectable) menuItemSelectable.addEventListener("keydown", this._handleKeydown);
...
CDSmenuItemSelectable = __decorate([carbonElement(`${prefix}-menu-item-selectable`)], CDSmenuItemSelectable);
var menu_item_selectable_default = CDSmenuItemSelectable;

//#endregion
export { menu_item_selectable_default as default };
