...
CDSSideNavMenu = __decorate([carbonElement(`${prefix}-side-nav-menu`)], CDSSideNavMenu);
var side_nav_menu_default = CDSSideNavMenu;

//#endregion
export { side_nav_menu_default as default };
