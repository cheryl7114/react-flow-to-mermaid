...
CDSHeaderNavItem = __decorate([carbonElement(`${prefix}-header-nav-item`)], CDSHeaderNavItem);
var header_nav_item_default = CDSHeaderNavItem;

//#endregion
export { header_nav_item_default as default };
