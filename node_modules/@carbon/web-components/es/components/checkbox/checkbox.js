...
import checkbox_default$1 from "./checkbox.scss.js";
...
let CDSCheckbox = class CDSCheckbox extends FocusMixin(FormMixin(LitElement)) {
	...
	*/
	...
	render() {
		...
		const helper = helperText ? html` <div class="${prefix}--form__helper-text">${helperText}</div>` : null;
		const labelClasses = classMap({ [`${prefix}--checkbox-label`]: true });
      ...
      <div class="${prefix}--checkbox__validation-msg">
        ${!readonly && invalid ? html`
              ${iconLoader(WarningFilled16, { class: `${prefix}--checkbox__invalid-icon` })}
              <div class="${prefix}--form-requirement">${invalidText}</div>
            ` : null}
        ${showWarning ? html`
              ${iconLoader(WarningAltFilled16, { class: `${prefix}--checkbox__invalid-icon ${prefix}--checkbox__invalid-icon--warning` })}
	...
	*/
	...
	static {
		this.styles = checkbox_default$1;
	}
};
...
__decorate([property({ type: Boolean })], CDSCheckbox.prototype, "invalid", void 0);
__decorate([property({
	type: String,
...
__decorate([property({ type: Boolean })], CDSCheckbox.prototype, "warn", void 0);
__decorate([property({
	type: String,
	attribute: "warn-text"
...
CDSCheckbox = __decorate([carbonElement(`${prefix}-checkbox`)], CDSCheckbox);
var checkbox_default = CDSCheckbox;
