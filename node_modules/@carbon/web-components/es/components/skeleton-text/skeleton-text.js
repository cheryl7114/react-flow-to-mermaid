...
import skeleton_text_default$1 from "./skeleton-text.scss.js";
...
let CDSSkeletonText = class CDSSkeletonText extends LitElement {
	...
	static {
		this.styles = skeleton_text_default$1;
	}
};
__decorate([property({
	reflect: true,
...
CDSSkeletonText = __decorate([carbonElement(`${prefix}-skeleton-text`)], CDSSkeletonText);
var skeleton_text_default = CDSSkeletonText;

//#endregion
export { SKELETON_TEXT_TYPE, skeleton_text_default as default };
