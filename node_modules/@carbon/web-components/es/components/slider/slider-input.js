...
let CDSSliderInput = class CDSSliderInput extends FocusMixin(LitElement) {
	...
	*/
	...
	render() {
		...
		const invalidIcon = iconLoader(WarningFilled16, { class: `${prefix}--slider__invalid-icon` });
		const warnIcon = iconLoader(WarningAltFilled16, { class: `${prefix}--slider__invalid-icon ${prefix}--slider__invalid-icon--warning` });
		return html`
      <input
        ?disabled="${disabled}"
...
CDSSliderInput = __decorate([carbonElement(`${prefix}-slider-input`)], CDSSliderInput);
var slider_input_default = CDSSliderInput;

//#endregion
export { slider_input_default as default };
