...
import form_group_default$1 from "./form-group.scss.js";
...
let CDSFormGroup = class CDSFormGroup extends LitElement {
	...
	render() {
      ...
      <fieldset
        ...
        <slot></slot>
        ${message ? html`<div class="${prefix}--form__requirements">
              ${messageText}
            </div>` : null}
      </fieldset>
    `;
	...
	static {
		this.styles = form_group_default$1;
	}
};
__decorate([property({
	type: Boolean,
...
CDSFormGroup = __decorate([carbonElement(`${prefix}-form-group`)], CDSFormGroup);
var form_group_default = CDSFormGroup;
