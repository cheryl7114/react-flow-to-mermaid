...
//#region src/components/date-picker/state-handshake-plugin.ts
/**
* @param datePicker Plugin configuration.
* @returns A Flatpickr plugin to handshake states with `<cds-date-picker>`.
*/
var state_handshake_plugin_default = (datePicker) => (fp) => {
	/**
	* Sets open state.
	*/
	const setOpen = () => {
...
//#endregion
export { state_handshake_plugin_default as default };
