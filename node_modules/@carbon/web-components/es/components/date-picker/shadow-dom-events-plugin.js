...
//#region src/components/date-picker/shadow-dom-events-plugin.ts
/**
...
*/
var shadow_dom_events_plugin_default = () => (fp) => {
	...
	*/
	const handleKeydown = (event) => {
		...
		if (key === "Enter") target.dispatchEvent(Object.assign(new CustomEvent("mousedown", { bubbles: true }), { which: 1 }));
			...
			if (movedDateElem) movedDateElem.focus();
			else {
	...
	*/
	const release = () => {
		if (fp._hCDSCEDatePickerShadowDOMEventsPluginKeydown) fp._hCDSCEDatePickerShadowDOMEventsPluginKeydown = fp._hCDSCEDatePickerShadowDOMEventsPluginKeydown.release();
	};
	/**
...
//#endregion
export { shadow_dom_events_plugin_default as default };
