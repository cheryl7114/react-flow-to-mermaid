...
//#region src/components/date-picker/iso-date.ts
/**
...
*/
const getISODateString = (date) => new Date(Date.UTC(date.getFullYear(), date.getMonth(), date.getDate())).toISOString().split("T")[0];
/**
...
*/
const parseISODateString = (s) => {
	const utcDate = new Date(Date.parse(s));
	return new Date(utcDate.getUTCFullYear(), utcDate.getUTCMonth(), utcDate.getUTCDate());
};

//#endregion
export { getISODateString, parseISODateString };
