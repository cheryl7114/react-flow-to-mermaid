...
*/
let CDSBreadcrumbLink = class CDSBreadcrumbLink extends link_default {
	constructor(..._args) {
		super(..._args);
...
CDSBreadcrumbLink = __decorate([carbonElement(`${prefix}-breadcrumb-link`)], CDSBreadcrumbLink);
var breadcrumb_link_default = CDSBreadcrumbLink;

//#endregion
export { breadcrumb_link_default as default };
