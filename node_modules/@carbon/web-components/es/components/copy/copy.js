...
import icon_button_default from "../icon-button/icon-button.js";
...
* @element cds-copy
*/
let CDSCopy = class CDSCopy extends icon_button_default {
	constructor(..._args) {
		super(..._args);
...
CDSCopy = __decorate([carbonElement(`${prefix}-copy`)], CDSCopy);
var copy_default = CDSCopy;
