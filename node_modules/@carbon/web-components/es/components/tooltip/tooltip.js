...
import popover_default$1 from "../popover/popover.js";
import "../popover/popover-content.js";
import tooltip_default$1 from "./tooltip.scss.js";
...
* @element cds-tooltip
*/
let CDSTooltip = class CDSTooltip extends HostListenerMixin(popover_default$1) {
	constructor(..._args) {
		super(..._args);
		this.align = "top";
	...
	*/
	...
	connectedCallback() {
		...
		adoptStyles(this.renderRoot, [popover_default, tooltip_default$1]);
	}
	...
	updated(changedProperties) {
		...
		this.shadowRoot?.querySelector(`.${prefix}--popover-container`)?.classList.add(`${prefix}--tooltip`);
...
CDSTooltip = __decorate([carbonElement(`${prefix}-tooltip`)], CDSTooltip);
var tooltip_default = CDSTooltip;
