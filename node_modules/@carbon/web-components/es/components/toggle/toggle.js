...
import toggle_default$1 from "./toggle.scss.js";
...
*/
let CDSToggle = class CDSToggle extends HostListenerMixin(checkbox_default) {
	constructor(..._args) {
		super(..._args);
		this.labelA = "On";
	...
	*/
	...
	_renderCheckmark() {
		if (this.size !== TOGGLE_SIZE.SMALL || this.readOnly == true) return;
		return html`
      <svg
...
CDSToggle = __decorate([carbonElement(`${prefix}-toggle`)], CDSToggle);
var toggle_default = CDSToggle;

//#endregion
export { TOGGLE_SIZE, toggle_default as default };
