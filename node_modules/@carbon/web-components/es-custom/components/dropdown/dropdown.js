...
import dropdown_default$1 from "./dropdown.scss.js";
...
let CDSDropdown = class CDSDropdown extends ValidityMixin(HostListenerMixin(FormMixin(FocusMixin(LitElement)))) {
    ...
    `;
      ...
      <div
        ...
        <div
          ...
          part="trigger-button"
          tabindex="${ifDefined(!shouldTriggerBeFocusable ? void 0 : "0")}"
	...
	*/
	...
	static {
		this.styles = dropdown_default$1;
	}
	/**
	* @returns A action for dropdown for the given key symbol.
	*/
	static getAction(key) {
		if (key === "Escape") return DROPDOWN_KEYBOARD_ACTION.CLOSING;
		if (key in NAVIGATION_DIRECTION) return DROPDOWN_KEYBOARD_ACTION.NAVIGATING;
		if (this.TRIGGER_KEYS.has(key)) return DROPDOWN_KEYBOARD_ACTION.TRIGGERING;
		return DROPDOWN_KEYBOARD_ACTION.NONE;
	}
};
__decorate([state()], CDSDropdown.prototype, "_activeDescendant", void 0);
__decorate([query(`.${prefix}--list-box`)], CDSDropdown.prototype, "_listBoxNode", void 0);
...
__decorate([property({ reflect: true })], CDSDropdown.prototype, "value", void 0);
__decorate([property({
	type: Boolean,
	reflect: true
})], CDSDropdown.prototype, "warn", void 0);
__decorate([property({ attribute: "warn-text" })], CDSDropdown.prototype, "warnText", void 0);
CDSDropdown = __decorate([carbonElement(`${prefix}-dropdown`)], CDSDropdown);
var dropdown_default = CDSDropdown;

//#endregion
export { DROPDOWN_DIRECTION, DROPDOWN_KEYBOARD_ACTION, DROPDOWN_SIZE, DROPDOWN_TYPE, NAVIGATION_DIRECTION, dropdown_default as default };
