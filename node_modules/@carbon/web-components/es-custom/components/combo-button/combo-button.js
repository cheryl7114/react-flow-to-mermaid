...
let CDSComboButton = class CDSComboButton extends HostListenerMixin(LitElement) {
	...
	static {
		this.styles = combo_button_default$1;
	}
};
__decorate([query(`${prefix}-icon-button`)], CDSComboButton.prototype, "_triggerNode", void 0);
__decorate([query(`${prefix}-menu`)], CDSComboButton.prototype, "_menuNode", void 0);
__decorate([property({
	type: Boolean,
	reflect: true
...
CDSComboButton = __decorate([carbonElement(`${prefix}-combo-button`)], CDSComboButton);
var combo_button_default = CDSComboButton;

//#endregion
export { COMBO_BUTTON_SIZE, COMBO_BUTTON_TOOLTIP_ALIGNMENT, combo_button_default as default };
