...
let CDSShapeIndicator = class CDSShapeIndicator extends LitElement {
	...
	render() {
		...
		if (typeof shape === "string") return html` ${iconLoader(null, {}, shape)} ${this.label} `;
...
CDSShapeIndicator = __decorate([carbonElement(`${prefix}-shape-indicator`)], CDSShapeIndicator);
