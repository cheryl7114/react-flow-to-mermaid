      ...
      <div class="${prefix}--table-expand">
        <div>
          ...
          ${this.expandable ? html`<button
                ...
                ${iconLoader(ChevronRight16, { class: `${prefix}--table-expand__svg` })}
              </button>` : html`&nbsp;`}
...
CDSTableRow = __decorate([carbonElement(`${prefix}-table-row`)], CDSTableRow);
var table_row_default = CDSTableRow;
