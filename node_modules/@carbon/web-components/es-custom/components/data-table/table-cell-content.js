...
CDSTableCellContent = __decorate([carbonElement(`${prefix}-table-cell-content`)], CDSTableCellContent);
var table_cell_content_default = CDSTableCellContent;

//#endregion
export { table_cell_content_default as default };
