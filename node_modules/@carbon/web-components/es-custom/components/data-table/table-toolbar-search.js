...
import search_default from "../search/search.js";
...
*/
let CDSTableToolbarSearch = class CDSTableToolbarSearch extends HostListenerMixin(search_default) {
	constructor(..._args) {
		super(..._args);
		this.expanded = false;
...
CDSTableToolbarSearch = __decorate([carbonElement(`${prefix}-table-toolbar-search`)], CDSTableToolbarSearch);
var table_toolbar_search_default = CDSTableToolbarSearch;

//#endregion
export { table_toolbar_search_default as default };
