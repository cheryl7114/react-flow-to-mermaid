...
import menu_button_default$1 from "./menu-button.scss.js";
...
let CDSMenuButton = class CDSMenuButton extends HostListenerMixin(LitElement) {
	constructor(..._args) {
		...
		this._handleClick = (event) => {
			...
			else if (this._open) this._closeMenu();
		};
	...
	static {
		this.styles = menu_button_default$1;
	}
...
__decorate([query(`${prefix}-button`)], CDSMenuButton.prototype, "_triggerNode", void 0);
__decorate([property({
	type: Boolean,
	reflect: true
...
__decorate([HostListener(`${prefix}-menu-closed`)], CDSMenuButton.prototype, "_handleMenuClosed", void 0);
CDSMenuButton = __decorate([carbonElement(`${prefix}-menu-button`)], CDSMenuButton);
var menu_button_default = CDSMenuButton;

//#endregion
export { MENU_BUTTON_KIND, MENU_BUTTON_SIZE, menu_button_default as default };
