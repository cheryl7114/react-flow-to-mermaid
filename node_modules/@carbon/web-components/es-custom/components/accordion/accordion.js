...
import accordion_default$1 from "./accordion.scss.js";
...
let CDSAccordion = class CDSAccordion extends LitElement {
	...
	static {
		this.styles = accordion_default$1;
	}
};
...
CDSAccordion = __decorate([carbonElement(`${prefix}-accordion`)], CDSAccordion);
var accordion_default = CDSAccordion;

//#endregion
export { ACCORDION_ALIGNMENT, ACCORDION_SIZE, accordion_default as default };
