...
CDSAccordionItem = __decorate([carbonElement(`${prefix}-accordion-item`)], CDSAccordionItem);
var accordion_item_default = CDSAccordionItem;

//#endregion
export { ACCORDION_ITEM_BREAKPOINT, accordion_item_default as default };
