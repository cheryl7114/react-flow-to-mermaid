...
*/
let CDSMultiSelectItem = class CDSMultiSelectItem extends dropdown_item_default {
	constructor(..._args) {
		super(..._args);
...
CDSMultiSelectItem = __decorate([carbonElement(`${prefix}-multi-select-item`)], CDSMultiSelectItem);
var multi_select_item_default = CDSMultiSelectItem;

//#endregion
export { multi_select_item_default as default };
