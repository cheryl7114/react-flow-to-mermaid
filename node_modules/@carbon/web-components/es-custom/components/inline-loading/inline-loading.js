...
import inline_loading_default$1 from "./inline-loading.scss.js";
...
let CDSInlineLoading = class CDSInlineLoading extends LitElement {
	...
	*/
	_renderIcon() {
		...
		if (status === INLINE_LOADING_STATE.ERROR) return iconLoader(ErrorFilled16, {
		...
		if (status === INLINE_LOADING_STATE.INACTIVE || status === INLINE_LOADING_STATE.ACTIVE) return html`
        <div class="${classMap({
			[`${prefix}--loading`]: true,
	...
	static {
		this.styles = inline_loading_default$1;
	}
};
...
CDSInlineLoading = __decorate([carbonElement(`${prefix}-inline-loading`)], CDSInlineLoading);
var inline_loading_default = CDSInlineLoading;

//#endregion
export { INLINE_LOADING_STATE, inline_loading_default as default };
