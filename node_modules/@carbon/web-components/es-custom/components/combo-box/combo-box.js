...
import combo_box_default$1 from "./combo-box.scss.js";
...
*/
let CDSComboBox = class CDSComboBox extends dropdown_default {
	constructor(..._args) {
		super(..._args);
	...
	*/
	...
	updated(changedProperties) {
		...
		if (listBoxNode) listBoxNode.classList.add(`${prefix}--combo-box`);
	}
	_resetFilteredItems() {
	...
	*/
	...
	static {
		this.styles = combo_box_default$1;
	}
};
...
CDSComboBox = __decorate([carbonElement(`${prefix}-combo-box`)], CDSComboBox);
var combo_box_default = CDSComboBox;

//#endregion
export { DROPDOWN_DIRECTION, DROPDOWN_SIZE, combo_box_default as default };
