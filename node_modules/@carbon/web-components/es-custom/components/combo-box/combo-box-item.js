...
import dropdown_item_default from "../dropdown/dropdown-item.js";
...
*/
let CDSComboBoxItem = class CDSComboBoxItem extends dropdown_item_default {
	constructor(..._args) {
		super(..._args);
	...
	_getNextItem() {
		...
		while (next) {
			if (next instanceof HTMLElement && next.tagName.toLowerCase() === `${prefix}-combo-box-item`) return next;
...
CDSComboBoxItem = __decorate([carbonElement(`${prefix}-combo-box-item`)], CDSComboBoxItem);
var combo_box_item_default = CDSComboBoxItem;

//#endregion
export { combo_box_item_default as default };
