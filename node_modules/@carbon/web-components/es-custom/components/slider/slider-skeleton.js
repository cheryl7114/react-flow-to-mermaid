...
CDSSliderSkeleton = __decorate([carbonElement(`${prefix}-slider-skeleton`)], CDSSliderSkeleton);
var slider_skeleton_default = CDSSliderSkeleton;

//#endregion
export { slider_skeleton_default as default };
