...
import { INPUT_SIZE, INPUT_TYPE } from "../defs.js";
...
const createProps = ({ boolean, textNonEmpty, select }) => {
	...
	return {
		...
		showPasswordVisibilityToggle: type === INPUT_TYPE.TEXT || type === INPUT_TYPE.PASSWORD ? boolean("Show password visibility toggle (show-password-visibility-toggle)", false) : null,
