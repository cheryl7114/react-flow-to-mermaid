...
import toggletip_default$1 from "../toggle-tip/toggletip.js";
import ai_label_default$1 from "./ai-label.scss.js";
...
*/
let CDSAILabel = class CDSAILabel extends toggletip_default$1 {
	constructor(..._args) {
		super(..._args);
		this.slot = "ai-label";
		this.aiText = "AI";
      ...
      <button
        ...
        ${aiTextLabel && kind === AI_LABEL_KIND.INLINE ? html`
...
CDSAILabel = __decorate([carbonElement(`${prefix}-ai-label`)], CDSAILabel);
var ai_label_default = CDSAILabel;

//#endregion
export { ai_label_default as default };
