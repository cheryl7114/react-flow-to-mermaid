...
import heading_default$1 from "./heading.scss.js";
...
let CDSSection = class CDSSection extends LitElement {
	...
	getParentLevel() {
		const parentSection = this.parentElement?.closest(`${prefix}-section`);
...
CDSSection = __decorate([customElement(`${prefix}-section`)], CDSSection);
/**
...
let CDSHeading = class CDSHeading extends LitElement {
	...
	static {
		this.styles = heading_default$1;
	}
};
CDSHeading = __decorate([customElement(`${prefix}-heading`)], CDSHeading);
var heading_default = CDSHeading;

//#endregion
export { CDSSection, heading_default as default };
