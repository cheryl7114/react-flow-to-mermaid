...
let CDSCheckboxGroup = class CDSCheckboxGroup extends LitElement {
	...
	updated(changedProperties) {
		...
		if (changedProperties.has("invalid")) {
			const { invalid } = this;
			checkboxes.forEach((elem) => {
				if (invalid) elem.setAttribute("invalid-group", "");
	...
	render() {
		...
		const helper = helperText ? html` <div id="${helperId}" class="${prefix}--form__helper-text">
          ${helperText}
        </div>` : null;
		return html`
      <fieldset
...
CDSCheckboxGroup = __decorate([carbonElement(`${prefix}-checkbox-group`)], CDSCheckboxGroup);
var checkbox_group_default = CDSCheckboxGroup;

//#endregion
export { CHECKBOX_ORIENTATION, checkbox_group_default as default };
