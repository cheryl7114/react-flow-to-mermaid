...
CDSSelectableTag = __decorate([carbonElement(`${prefix}-selectable-tag`)], CDSSelectableTag);
var selectable_tag_default = CDSSelectableTag;

//#endregion
export { TAG_SIZE, TAG_TYPE, selectable_tag_default as default };
