...
let CDSContentSwitcherItem = class CDSContentSwitcherItem extends FocusMixin(LitElement) {
	...
	updated(changedProperties) {
		if (changedProperties) this.shadowRoot?.querySelector(`${prefix}-tooltip`)?.classList.add(`${prefix}--icon-tooltip`);
...
CDSContentSwitcherItem = __decorate([carbonElement(`${prefix}-content-switcher-item`)], CDSContentSwitcherItem);
var content_switcher_item_default = CDSContentSwitcherItem;

//#endregion
export { content_switcher_item_default as default };
