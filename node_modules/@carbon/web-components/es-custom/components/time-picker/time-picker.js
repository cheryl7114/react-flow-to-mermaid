...
import time_picker_default$1 from "./time-picker.scss.js";
...
let CDSTimePicker = class CDSTimePicker extends ValidityMixin(FormMixin(LitElement)) {
	...
	*/
          ...
          <div class="${prefix}--time-picker__input">
            ...
            ${normalizedProps.invalid || normalizedProps.warn ? html`
                  <div class="${prefix}--time-picker__error__icon">
                    ${normalizedProps.invalid ? iconLoader(WarningFilled16, { class: `${prefix}--checkbox__invalid-icon` }) : iconLoader(WarningAltFilled16, { class: `${prefix}--text-input__invalid-icon--warning` })}
                  </div>
                ` : null}
          </div>
	...
	static {
		this.styles = time_picker_default$1;
	}
};
...
CDSTimePicker = __decorate([carbonElement(`${prefix}-time-picker`)], CDSTimePicker);
var time_picker_default = CDSTimePicker;
