...
CDSOverflowMenuItem = __decorate([carbonElement(`${prefix}-overflow-menu-item`)], CDSOverflowMenuItem);
var overflow_menu_item_default = CDSOverflowMenuItem;

//#endregion
export { overflow_menu_item_default as default };
