...
import { NAVIGATION_DIRECTION, OVERFLOW_MENU_SIZE } from "./defs.js";
				...
				*/
				...
				if (key === "Escape") {
					...
					requestAnimationFrame(() => {
						const triggerButton = menuTrigger?.shadowRoot?.querySelector(`button.${prefix}--overflow-menu`) || menuTrigger?.querySelector(`button.${prefix}--overflow-menu`);
						if (triggerButton) triggerButton.focus();
					});
					return;
				}
				const items = this.querySelectorAll(_CDSOverflowMenuBody.selectorItemEnabled);
...
CDSOverflowMenuBody = _CDSOverflowMenuBody = __decorate([carbonElement(`${prefix}-overflow-menu-body`)], CDSOverflowMenuBody);
var overflow_menu_body_default = CDSOverflowMenuBody;

//#endregion
export { overflow_menu_body_default as default };
