...
CDSNumberInputSkeleton = __decorate([carbonElement(`${prefix}-number-input-skeleton`)], CDSNumberInputSkeleton);
var number_input_skeleton_default = CDSNumberInputSkeleton;

//#endregion
export { number_input_skeleton_default as default };
