...
//#region src/components/date-picker/month-select-plugin.ts
/**
...
*/
var month_select_plugin_default = (config) => (fp) => {
	/**
	...
	*/
	const setupElements = () => {
		...
		monthElements.splice(0, monthElements.length, ...monthElements.map(() => {
			...
			if (monthYearContainer) monthYearContainer.insertBefore(monthElement, yearElements[0].closest(selectorFlatpickrYearContainer));
			return monthElement;
		}));
	};
	/**
	...
	*/
	const updateCurrentMonth = () => {
		...
		yearElements.forEach((elem) => {
			...
			if (currentMonthContainer) forEach(currentMonthContainer.querySelectorAll(selectorFlatpickrCurrentMonth), (monthElement) => {
...
//#endregion
export { month_select_plugin_default as default };
