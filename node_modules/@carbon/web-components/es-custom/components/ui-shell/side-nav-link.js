...
CDSSideNavLink = __decorate([carbonElement(`${prefix}-side-nav-link`)], CDSSideNavLink);
var side_nav_link_default = CDSSideNavLink;

//#endregion
export { side_nav_link_default as default };
