...
import side_nav_default$1 from "./side-nav.scss.js";
...
let CDSSideNav = class CDSSideNav extends HostListenerMixin(LitElement) {
	...
	*/
	_handleFocusIn() {
		const { collapseMode } = this;
		if (collapseMode !== SIDE_NAV_COLLAPSE_MODE.FIXED) this.expanded = true;
	}
	/**
	...
	*/
	...
	render() {
		...
		return html`${this.collapseMode === SIDE_NAV_COLLAPSE_MODE.FIXED ? null : html`<div
	...
	*/
	...
	static {
		this.styles = side_nav_default$1;
	}
};
...
CDSSideNav = __decorate([carbonElement(`${prefix}-side-nav`)], CDSSideNav);
var side_nav_default = CDSSideNav;

//#endregion
export { SIDE_NAV_COLLAPSE_MODE, SIDE_NAV_USAGE_MODE, side_nav_default as default };
