...
CDSSideNavMenuItem = __decorate([carbonElement(`${prefix}-side-nav-menu-item`)], CDSSideNavMenuItem);
var side_nav_menu_item_default = CDSSideNavMenuItem;

//#endregion
export { side_nav_menu_item_default as default };
