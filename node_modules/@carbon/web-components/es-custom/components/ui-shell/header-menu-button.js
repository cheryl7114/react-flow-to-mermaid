...
CDSHeaderMenuButton = __decorate([carbonElement(`${prefix}-header-menu-button`)], CDSHeaderMenuButton);
var header_menu_button_default = CDSHeaderMenuButton;

//#endregion
export { header_menu_button_default as default };
