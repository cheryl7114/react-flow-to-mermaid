...
let CDSTreeNode = class CDSTreeNode extends LitElement {
	...
	*/
	...
	render() {
		...
		if (isExpanded) toggleClasses += `${prefix}--tree-parent-node__toggle-icon--expanded`;
      ...
      ${!hasChildren ? html`
            ${href ? html`<a
                ...
                </a>` : html` <div id="label" class="${prefix}--tree-node__label">
          ...
          ` : html`
            ${href ? html` <a
                  ...
                  </ul>` : html`<div id="label" class="${prefix}--tree-node__label">
                    <span
                      class="${prefix}--tree-parent-node__toggle"
                      ?disabled=${disabled}
                      @click=${handleToggleClick}>
...
CDSTreeNode = __decorate([carbonElement(`${prefix}-tree-node`)], CDSTreeNode);
var tree_node_default = CDSTreeNode;
