...
CDSModalCloseButton = __decorate([carbonElement(`${prefix}-modal-close-button`)], CDSModalCloseButton);
var modal_close_button_default = CDSModalCloseButton;

//#endregion
export { modal_close_button_default as default };
