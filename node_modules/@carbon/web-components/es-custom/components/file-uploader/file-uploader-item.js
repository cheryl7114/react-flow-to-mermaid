...
let CDSFileUploaderItem = class CDSFileUploaderItem extends LitElement {
	...
	*/
	_renderEditing() {
		...
		return html`
      ${!invalid ? void 0 : iconLoader(WarningFilled16, { class: `${prefix}--file-invalid` })}
      <button
        type="button"
	...
	*/
	_renderStatus() {
		const { state } = this;
		switch (state) {
			case FILE_UPLOADER_ITEM_STATE.EDIT: return this._renderEditing();
			case FILE_UPLOADER_ITEM_STATE.UPLOADING: return this._renderUploading();
			case FILE_UPLOADER_ITEM_STATE.COMPLETE: return this._renderUploaded();
			default: return;
		}
	}
	render() {
...
CDSFileUploaderItem = __decorate([carbonElement(`${prefix}-file-uploader-item`)], CDSFileUploaderItem);
var file_uploader_item_default = CDSFileUploaderItem;

//#endregion
export { FILE_UPLOADER_ITEM_SIZE, FILE_UPLOADER_ITEM_STATE, file_uploader_item_default as default };
