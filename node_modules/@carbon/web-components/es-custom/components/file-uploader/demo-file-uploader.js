...
CDSCEDemoFileUploader = __decorate([carbonElement(`${prefix}-ce-demo-file-uploader`)], CDSCEDemoFileUploader);
var demo_file_uploader_default = CDSCEDemoFileUploader;

//#endregion
export { demo_file_uploader_default as default };
