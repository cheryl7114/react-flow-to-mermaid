...
CDSFileUploaderSkeleton = __decorate([carbonElement(`${prefix}-file-uploader-skeleton`)], CDSFileUploaderSkeleton);
var file_uploader_skeleton_default = CDSFileUploaderSkeleton;

//#endregion
export { file_uploader_skeleton_default as default };
