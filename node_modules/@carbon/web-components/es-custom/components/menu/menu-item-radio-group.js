...
let CDSmenuItemRadioGroup = class CDSmenuItemRadioGroup extends LitElement {
	...
	*/
	...
	updated(_changedProperties) {
		if (_changedProperties.has("selectedItem")) this.querySelectorAll(`${prefix}-menu-item`).forEach((item) => {
...
CDSmenuItemRadioGroup = __decorate([carbonElement(`${prefix}-menu-item-radio-group`)], CDSmenuItemRadioGroup);
var menu_item_radio_group_default = CDSmenuItemRadioGroup;

//#endregion
export { menu_item_radio_group_default as default };
