...
import inline_notification_default from "./inline-notification.js";
import actionable_notification_default$1 from "./actionable-notification.scss.js";
...
* LICENSE file in the root directory of this source tree.
*/
var _CDSActionableNotification;
/**
...
*/
let CDSActionableNotification = class CDSActionableNotification extends HostListenerMixin(inline_notification_default) {
	static {
		_CDSActionableNotification = this;
	}
	constructor(..._args) {
		super(..._args);
		...
		this._handleBlur = async ({ target, relatedTarget }) => {
			...
			if (open && this.getAttribute("role") === "alertdialog" && relatedTarget && !(relatedTarget instanceof _CDSActionableNotification) && oldContains && !currentContains) {
	...
	_renderIcon() {
		...
		return !IconComponent ? void 0 : iconLoader(IconComponent, { class: `${prefix}--${inline ? "inline" : "toast"}-notification__icon` });
	}
	_renderText() {
      ...
      <div class="${prefix}--${type}-notification__text-wrapper">
        <div class="${prefix}--${type}-notification__content">
          ...
          ${caption && html`<div class="${prefix}--${type}-notification__caption">
	...
	*/
	...
	static {
		this.styles = actionable_notification_default$1;
	}
};
__decorate([property({
	type: Boolean,
...
CDSActionableNotification = _CDSActionableNotification = __decorate([carbonElement(`${prefix}-actionable-notification`)], CDSActionableNotification);
var actionable_notification_default = CDSActionableNotification;

//#endregion
export { actionable_notification_default as default, iconsForKinds };
