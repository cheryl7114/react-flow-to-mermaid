...
import inline_notification_default$1 from "./inline-notification.scss.js";
...
//#region src/components/notification/inline-notification.ts
/**
...
let CDSInlineNotification = class CDSInlineNotification extends FocusMixin(LitElement) {
	...
	*/
	_initializeTimeout(timeout) {
		if (this._timeoutID) this._cancelTimeout(this._timeoutID);
	...
	*/
	_renderButton() {
      ...
      <button
        ...
        ${iconLoader(Close16, { class: `${prefix}--${type}-notification__close-icon` })}
      </button>
    `;
	}
	/**
	...
	*/
	...
	updated(changedProperties) {
		...
		if (openChanged || timeoutChanged) {
			if (this.open && this.timeout) this._initializeTimeout(this.timeout);
			else if (!this.open && this._timeoutID) this._cancelTimeout(this._timeoutID);
		}
	}
	render() {
	...
	*/
	...
	static {
		this.styles = inline_notification_default$1;
	}
};
__decorate([property({ attribute: "aria-label" })], CDSInlineNotification.prototype, "ariaLabel", void 0);
__decorate([property({
	type: Boolean,
	reflect: true,
	attribute: "hide-close-button"
})], CDSInlineNotification.prototype, "hideCloseButton", void 0);
__decorate([property({ attribute: "status-icon-description" })], CDSInlineNotification.prototype, "statusIconDescription", void 0);
__decorate([property({ reflect: true })], CDSInlineNotification.prototype, "kind", void 0);
__decorate([property({
	type: Boolean,
	reflect: true,
...
__decorate([property()], CDSInlineNotification.prototype, "subtitle", void 0);
__decorate([property()], CDSInlineNotification.prototype, "title", void 0);
CDSInlineNotification = __decorate([carbonElement(`${prefix}-inline-notification`)], CDSInlineNotification);
var inline_notification_default = CDSInlineNotification;

//#endregion
export { NOTIFICATION_KIND, NOTIFICATION_TYPE, inline_notification_default as default };
