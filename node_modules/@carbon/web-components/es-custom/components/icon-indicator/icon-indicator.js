...
import icon_indicator_default$1 from "./icon-indicator.scss.js";
...
let CDSIconIndicator = class CDSIconIndicator extends LitElement {
	...
	static {
		this.styles = icon_indicator_default$1;
	}
};
...
CDSIconIndicator = __decorate([carbonElement(`${prefix}-icon-indicator`)], CDSIconIndicator);
var icon_indicator_default = CDSIconIndicator;

//#endregion
export { ICON_INDICATOR_KIND, icon_indicator_default as default };
