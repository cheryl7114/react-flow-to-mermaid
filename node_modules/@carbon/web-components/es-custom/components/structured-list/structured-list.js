...
import structured_list_default$1 from "./structured-list.scss.js";
...
let CDSStructuredList = class CDSStructuredList extends FocusMixin(LitElement) {
	...
	static {
		this.selectorRowsWithHeader = `${prefix}-structured-list-row,${prefix}-structured-list-header-row`;
	}
	static {
	...
	static {
		this.styles = structured_list_default$1;
	}
};
...
CDSStructuredList = __decorate([carbonElement(`${prefix}-structured-list`)], CDSStructuredList);
var structured_list_default = CDSStructuredList;
