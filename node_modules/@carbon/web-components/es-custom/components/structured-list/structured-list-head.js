...
//#region src/components/structured-list/structured-list-head.ts
/**
...
*
* @element cds-custom-structured-list-head
*/
...
CDSStructuredListHeader = __decorate([carbonElement(`${prefix}-structured-list-head`)], CDSStructuredListHeader);
var structured_list_head_default = CDSStructuredListHeader;

//#endregion
export { structured_list_head_default as default };
