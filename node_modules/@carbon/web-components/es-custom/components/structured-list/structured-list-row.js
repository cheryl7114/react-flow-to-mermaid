...
CDSStructuredListRow = __decorate([carbonElement(`${prefix}-structured-list-row`)], CDSStructuredListRow);
var structured_list_row_default = CDSStructuredListRow;

//#endregion
export { structured_list_row_default as default };
