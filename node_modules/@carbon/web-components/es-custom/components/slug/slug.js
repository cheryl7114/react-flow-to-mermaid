...
import slug_default$1 from "./slug.scss.js";
...
* LICENSE file in the root directory of this source tree.
*/
let CDSSlug = class CDSSlug extends toggletip_default$1 {
	constructor(..._args) {
		super(..._args);
		this.slot = "slug";
		this.aiText = "AI";
      ...
      <button
        ...
        ${aiTextLabel && kind === SLUG_KIND.INLINE ? html`
...
CDSSlug = __decorate([carbonElement(`${prefix}-slug`)], CDSSlug);
var slug_default = CDSSlug;
