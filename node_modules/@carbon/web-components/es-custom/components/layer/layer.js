...
import layer_default$1 from "./layer.scss.js";
...
CDSLayer = __decorate([carbonElement(`${prefix}-layer`)], CDSLayer);
var layer_default = CDSLayer;

//#endregion
export { MAX_LEVEL, MIN_LEVEL, layer_default as default, levels };
