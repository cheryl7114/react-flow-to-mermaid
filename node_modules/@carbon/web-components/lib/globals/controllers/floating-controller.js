...
var FloatingController = class {
	...
	*/
	...
	async setPlacement(options = this.options) {
		...
		this.cleanup = (0, _floating_ui_dom.autoUpdate)(trigger, target, this.updatePlacement);
	}
	async computePlacement() {
		...
		const middleware = [
			(0, _floating_ui_dom.offset)(!isTabTip ? {
			...
			...matchWidth && (shimmedAlign === "bottom" || shimmedAlign === "top") ? [(0, _floating_ui_dom.size)({ apply({ rects, elements }) {
				elements.floating.style.width = `${rects.reference.width}px`;
			} })] : [(0, _floating_ui_dom.size)({ apply({ elements }) {
				elements.floating.style.removeProperty("width");
			} })],
			...caret && arrowElement ? [(0, _floating_ui_dom.arrow)({
		...
		if (open) {
			const { x, y, placement, middlewareData, strategy } = await (0, _floating_ui_dom.computePosition)(trigger, element, {
				strategy: "fixed",
				middleware,
