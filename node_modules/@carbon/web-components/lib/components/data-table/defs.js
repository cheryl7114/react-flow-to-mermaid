...
//#region src/components/data-table/defs.ts
/**
...
* Table size.
*/
let TABLE_SIZE = /* @__PURE__ */ function(TABLE_SIZE) {
	/**
	* xs size.
	*/
	TABLE_SIZE["XS"] = "xs";
...
* Table sort state.
*/
let TABLE_SORT_DIRECTION = /* @__PURE__ */ function(TABLE_SORT_DIRECTION) {
	/**
	* Not sorted.
	*/
	...
	*/
	...
	return TABLE_SORT_DIRECTION;
}({});
/**
* Table sort cycle.
*/
let TABLE_SORT_CYCLE = /* @__PURE__ */ function(TABLE_SORT_CYCLE) {
