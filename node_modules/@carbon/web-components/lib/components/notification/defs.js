...
//#region src/components/notification/defs.ts
/**
...
* Notification kinds.
*/
let NOTIFICATION_KIND = /* @__PURE__ */ function(NOTIFICATION_KIND) {
	/**
...
* Notification types.
*/
let NOTIFICATION_TYPE = /* @__PURE__ */ function(NOTIFICATION_TYPE) {
	/**
