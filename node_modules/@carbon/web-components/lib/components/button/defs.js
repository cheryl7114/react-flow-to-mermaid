...
//#region src/components/button/defs.ts
/**
...
* Button kind.
*/
let BUTTON_KIND = /* @__PURE__ */ function(BUTTON_KIND) {
	/**
	* Primary button.
	*/
...
* Button type.
*/
let BUTTON_TYPE = /* @__PURE__ */ function(BUTTON_TYPE) {
	/**
	* Default button type.
	*/
...
* Button size.
*/
let BUTTON_SIZE = /* @__PURE__ */ function(BUTTON_SIZE) {
	/**
	* Extra-small size.
	*/
...
*/
let BUTTON_TOOLTIP_ALIGNMENT = /* @__PURE__ */ function(BUTTON_TOOLTIP_ALIGNMENT) {
	/**
	...
	*/
	...
	return BUTTON_TOOLTIP_ALIGNMENT;
}({});
/**
* Button tooltip position.
*/
let BUTTON_TOOLTIP_POSITION = /* @__PURE__ */ function(BUTTON_TOOLTIP_POSITION) {
	/**
	...
	*/
	...
	return BUTTON_TOOLTIP_POSITION;
}({});

//#endregion
exports.BUTTON_KIND = BUTTON_KIND;
exports.BUTTON_SIZE = BUTTON_SIZE;
exports.BUTTON_TOOLTIP_ALIGNMENT = BUTTON_TOOLTIP_ALIGNMENT;
exports.BUTTON_TOOLTIP_POSITION = BUTTON_TOOLTIP_POSITION;
